#include "film_base8.h"
#include "resource_manager.h"

CFilmBase8::CFilmBase8(QWidget *parent) :
    CFilmBase(parent)
{
...
void CFilmBase8::SendCmdKey(int mKey)
{
...
void CFilmBase8::OnTimerFilmLong()
{
...
//扫描键码并显示
void CFilmBase8::filmKeyDisplay(unsigned short mKeyPhisic)
{
