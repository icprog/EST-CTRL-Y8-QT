...
CSimRail8::CSimRail8(QWidget *parent) :
    CSimBase8(parent)
{

    setObjectName("CSimRail8");
...
void CSimRail8::SimulateDataInit()
{
...
void CSimRail8::OnSimulateKey(int mKey)
{
    int mSmartIndex = -1;
