...
CSmartRail8::CSmartRail8(QWidget *parent) :
    CSmartBase8(parent)
{
    setObjectName("CSmartRail8");
    ...
    pBtnGroup[0]->setGeometry(pBtnGroup[8]->geometry());
...
void CSmartRail8::OnSmartChange(int mPos )
{
...
void CSmartRail8::OnSmartChange01(int mPos )
{
...
void CSmartRail8::OnSmartChange00(int mPos )
{
...
void CSmartRail8::OnSelfRunControl()
{
...
void CSmartRail8::OnSelfRunCtrlSoft()
{
    if(m_iTimerCounter < g_systemDb->m_SelfRunInterval) //判断时间间隔是否到达
        return;
...
void CSmartRail8::OnSelfRunCtrlHard()
{
//    unsigned long  wData;
...
void CSmartRail8::OnSelfRunCtrlMach()
{
